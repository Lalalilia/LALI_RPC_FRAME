...
#ifndef ZRPC_RPCTESTCLIENTSTUB_H
#define ZRPC_RPCTESTCLIENTSTUB_H
...
class RpcTestClientStub
{
public:
    RpcTestClientStub(EventLoop* loop, const AddressOps& serverAddress):
...
params.addMember("rhs", rhs);
    ...
    call.addMember("method", "RpcTest.Add");
...
params.addMember("rhs", rhs);
    ...
    json::Value call(json::TYPE_OBJECT);
    call.addMember("jsonrpc", "2.0");
    call.addMember("method", "RpcTest.Sub");
    call.addMember("params", params);
...
#endif //ZRPC_RPCTESTCLIENTSTUB_H
